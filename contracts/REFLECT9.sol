...
abstract contract REFLECT9 is Context, IERC20, ProxyOwnable {
    ...
    //R9, after bridge is deployed
    address public constant DEXTRADE0 =
        0x0661b42E18d93B3bed0B51EEAfBff57Ee0df9167;
    address public constant l1ESCROW =
        0x2470Ff677C1D52F492eE1F79825e7089375565A0;
    address public constant l1Gateway =
    ...
    function totalSupply() public view override returns (uint256) {
        uint256 sub = _burnFeeTotal.add(balanceOf(l1ESCROW));
        uint256 subAmount = sub.add(balanceOf(_burnAddress));
        return _tTotal.sub(subAmount);
    }
    ...
    function _transfer(
        ...
        // tx fee redirected to treasury for 6% of transaction value. Chnaged from 9% to 6% in R9.
        uint256 txFee = 6;
